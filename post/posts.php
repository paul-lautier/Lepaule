        ...
        <div class="container">
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th style="font-size: 25px;">Nom des Aisselles&nbsp; &nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                    <?php foreach($fetch_sub as $sub){?>
                        <tr>
                            <td style="font-size: 20px;line-height: 60px;"><?= $sub["sub_name"] ;?></td>
                            <td><button class="btn btn-primary active text-center d-block pull-right" type="button" style="height: 61px;background-color: rgb(0,105,217);"><a style="text-decoration:none"; href="create_post.php?id=<?= $sub["sub_id"]; ?>">Créer post</a></button></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
