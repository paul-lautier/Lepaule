                ...
                <table class="table">
                    ...
                    <?php foreach($fetch_sub as $sub){?>
                        <tr>
                            ...
                            <td><button class="btn btn-primary active text-center d-block pull-right" type="button" style="height: 61px;background-color: rgb(0,105,217);"><a href="edit_sub.php?id=<?= $sub["sub_id"]; ?>">edit sub</a></button></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
