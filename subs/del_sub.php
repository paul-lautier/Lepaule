        ...
        <div class="container">
            <div class="table-responsive">
                <table class="table">
                    <thead>
                        <tr>
                            <th style="font-size: 25px;">Nom de vos aisselles&nbsp; &nbsp;</th>
                        </tr>
                    </thead>
                    <tbody>
                    ...
                    <?php foreach($fetch_sub as $sub){?>
                        <tr>
                            ...
                            <td><button class="btn btn-primary active text-center d-block pull-right" type="button" style="height: 61px;background-color: rgb(0,105,217);"><a href="del_sub.php?delete=<?= $sub["sub_id"]; ?>">supprimer</a></button></td>
                        </tr>
                        <?php } ?>
                    </tbody>
                </table>
